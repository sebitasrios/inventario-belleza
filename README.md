...
erDiagram
  ...
  PROVEEDOR ||--o{ ENTRADA : "genera"
  ENTRADA ||--o{ DETALLE_MOVIMIENTO : "contiene"
  SALIDA ||--o{ DETALLE_MOVIMIENTO : "contiene"
  PRODUCTO ||--o{ DETALLE_MOVIMIENTO : "registra"
```
...
CREATE TABLE detalle_movimiento (
    ...
    CONSTRAINT fk_detalle_entrada FOREIGN KEY (id_entrada) REFERENCES entrada(id_entrada),
